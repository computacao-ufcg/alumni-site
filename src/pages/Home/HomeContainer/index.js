        ...
        <div id='content'>
          <div className='info'>
            <div className='paragraphs'>
              <p>
                Em <b>{year}</b>, a Unidade Acadêmica de Sistemas e Computação
                (UASC) da Universidade Federal de Campina Grande (UFCG) completa{" "}
                <b>{statistics.historyYears}</b> anos de existência. Nesses
                anos, formamos um total de{" "}
                <b>{statistics.numberAlumniCourse}</b> profissionais, que são
                reconhecidos no mercado de trabalho pela sua competência e ética
                profissional.
              </p>
              <p>
                Este sítio <i>web</i> traz estatísticas sobre a atuação desses
                egressos no mercado de trabalho. Os dados são obtidos através
                dos perfis públicos dos egressos no LinkedIn.
              </p>
              <p>
                Se você é graduado em um dos cursos oferecidos pela UASC/UFCG,
                nós o convidamos para juntar-se ao nosso grupo de egressos no
                LinkedIn para ter seus dados contabilizados aqui.
              </p>
              <p>
                Aqui também é possível consultar de forma mais simples os perfis
                de nossos egressos cadastrados no LinkedIn.
              </p>
            </div>
          </div>
